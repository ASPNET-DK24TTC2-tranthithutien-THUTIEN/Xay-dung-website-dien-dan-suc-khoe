    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Description", "DisplayOrder", "IconClass", "Name" },
                values: new object[,]
                {
                    { 1, "Thảo luận về chế độ ăn uống và dinh dưỡng", 1, "bi-egg-fried", "Dinh dưỡng" },
                    { 2, "Chia sẻ về các bài tập và phương pháp rèn luyện sức khỏe", 2, "bi-heart-pulse", "Tập luyện" },
                    { 3, "Đặt câu hỏi và nhận tư vấn về sức khỏe", 3, "bi-question-circle", "Hỏi đáp" },
                    { 4, "Thảo luận về sức khỏe tâm lý và tinh thần", 4, "bi-emoji-smile", "Sức khỏe tinh thần" },
                    { 5, "Thông tin và chia sẻ về các bệnh lý thường gặp", 5, "bi-hospital", "Bệnh lý" }
                });
